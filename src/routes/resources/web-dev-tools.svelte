...
<svelte:head>
  ...
  <meta
    name="description"
    content="Links to useful web development tools, speed tests, validators."
  />
</svelte:head>
...
<Layout {path}>
  <div class="mx-auto max-w-screen-md p-4 tracking-inter">
    ...
    >
        ...
        <ul>
          <li>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer nofollow">W3C HTML Markup Validator</a
            >
          </li>
          <li>
            <a
      ...
      <section>
        <h2 class="text-2xl">SEO Check</h2>
        <ul>
          <li>
            <a
      ...
      <section>
        <h2 class="text-2xl">Speed & Overall Tests</h2>
        <ul>
          <li>
            <a
      ...
      <section>
        <h2 class="text-2xl">Meta Tag Tests</h2>
        <ul>
          <li>
            <a
