...
<script>
  ...
  import IconArrowRight from "$lib/components/IconArrowRight.svelte";
...
<Layout {path}>
  <div class="mx-auto max-w-screen-md p-4">
    {#each menuItems as { href, name, bgColor, strokeColor, textColor }}
      ...
      >
        <div
          class="subpixel-antialiased text-transparent w-full transform-gpu -rotate-6 -translate-y-2 sm:-translate-y-6 md:-translate-y-7 -translate-x-4 sm:translate-x-0"
        >
          <svg
            class="h-full w-full"
        ...
        <div class="ml-auto text-blue-50"><IconArrowRight /></div>
      </a>
    {/each}
  </div>
</Layout>
